...
#ifndef AR_FRAMEWORK_SWIFT_H
#define AR_FRAMEWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AR_framework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12AR_framework38OverlayContainerPresentationController")
...
SWIFT_CLASS("_TtC12AR_framework43OverlayContainerSheetPresentationController")
...
SWIFT_CLASS("_TtC12AR_framework30OverlayContainerViewController")
...
SWIFT_CLASS("_TtC12AR_framework15PassThroughView")
...
SWIFT_CLASS("_TtC12AR_framework12SceneManager")
...
@interface SceneManager (SWIFT_EXTENSION(AR_framework)) <ARCoachingOverlayViewDelegate>
...
@interface SceneManager (SWIFT_EXTENSION(AR_framework)) <ARSCNViewDelegate>
...
@interface SceneManager (SWIFT_EXTENSION(AR_framework)) <SCNPhysicsContactDelegate>
...
SWIFT_CLASS("_TtC12AR_framework43TransparentOverlayContainerSheetDimmingView")
...
SWIFT_CLASS("_TtC12AR_framework13VirtualObject")
...
@interface VirtualObject (SWIFT_EXTENSION(AR_framework)) <SCNPhysicsContactDelegate>
- (void)physicsWorld:(SCNPhysicsWorld * _Nonnull)world didBeginContact:(SCNPhysicsContact * _Nonnull)contact;
- (void)physicsWorld:(SCNPhysicsWorld * _Nonnull)world didUpdateContact:(SCNPhysicsContact * _Nonnull)contact;
- (void)physicsWorld:(SCNPhysicsWorld * _Nonnull)world didEndContact:(SCNPhysicsContact * _Nonnull)contact;
@end
